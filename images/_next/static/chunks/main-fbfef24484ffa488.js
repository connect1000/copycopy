                    ...
                    function K() {
                        return K = s((function() {
                            ...
                            return l(this, (function(a) {
                                ...
                                }), I = P.getURL(), A.hasBasePath(I) && (I = R.removeBasePath(I)), T.scriptLoader && (0, n(20699).initScriptLoader)(T.scriptLoader), N = new j.default(T.buildId, e), t = function(e) {
                                    var t = u(e, 2),
                                        n = t[0],
                                        r = t[1];
                        ...
                        re = function() {
                            ...
                            return a(e, [{
                                ...
                                value: function(t, n, r, a, l) {
                                    var s = this;
                                    return u((function() {
                                        var u, f, y, m, g, w, S, L, T, N, Z, q, W, V, $, X, Y, J, Q, ee, ne, re, ae, oe, ie, ue, ce, le, se, fe, de, pe, he, ve, ye, me, ge, _e, be, Pe, we, Se, je, Oe, Ee, xe, Me, Ce, Re, Ae, ke, Le, Te, Ie, Ne, De, Be, Ze;
                                        return i(this, (function(i) {
                                            switch (i.label) {
                                                case 0:
                                                    if (!U(n)) return te({
                                                ...
                                                case 10:
                                                    ...
                                                    if (ne = C.removeLocale(R.removeBasePath(ne), y.locale), ae = d.removeTrailingSlash(X), oe = !1, b.isDynamicRoute(ae))
                                                        if (ie = P.parseRelativeUrl(ne), ue = ie.pathname, ce = O.getRouteRegex(ae), oe = j.getRouteMatcher(ce)(ue), se = (le = ae === ue) ? F(ae, ue, Y) : {}, !oe || le && !se.result) {
                                                ...
                                                case 12:
                                                    ...
                                                    if (Pe.pageProps && Pe.pageProps.__N_REDIRECT) return a.locale = !1, (Oe = Pe.pageProps.__N_REDIRECT).startsWith("/") && !1 !== Pe.pageProps.__N_REDIRECT_BASE_PATH ? ((Ee = P.parseRelativeUrl(Oe)).pathname = G(Ee.pathname, J), xe = z(s, Oe, Oe), Me = xe.url, Ce = xe.as, [2, s.change(t, Me, Ce, a)]) : (te({
                                                        url: Oe,
                                                        router: s
                                                    }), [2, new Promise((function() {}))]);
                                ...
                                value: function(e) {
                                    var t = e.route,
                                        ...
                                        y = this;
                                    return u((function() {
                                        var e, g, _, b, P, w, S, j, O, x, M, C, A, k, L, T;
                                        return i(this, (function(I) {
                                            switch (I.label) {
                                                case 0:
                                                    e = t, I.label = 1;
                                                case 1:
                                                    return I.trys.push([1, 6, , 7]), P = ne({
                                                        route: e,
                                                        router: y
                                                    }), w = y.components[e], l.shallow && w && y.route === e ? [2, w] : (f && (w = void 0), S = w && !("initial" in w) ? w : void 0, j = {
                                                ...
                                                case 2:
                                                    return O = I.sent(), P(), "redirect-internal" === (null == O || null == (g = O.effect) ? void 0 : g.type) || "redirect-external" === (null == O || null == (_ = O.effect) ? void 0 : _.type) ? [2, O.effect] : "rewrite" === (null == O || null == (b = O.effect) ? void 0 : b.type) && (e = d.removeTrailingSlash(O.effect.resolvedHref), n = O.effect.resolvedHref, r = c({}, r, O.effect.parsedAs.query), o = R.removeBasePath(m.normalizeLocalePath(O.effect.parsedAs.pathname, y.locales).pathname), w = y.components[e], l.shallow && w && y.route === e && !f) ? [2, c({}, w, {
                                                        route: e
                                                ...
                                                case 5:
                                                    return A = I.sent(), k = A.props, L = A.cacheKey, x.__N_SSP && j.dataHref && delete y.sdc[L], !y.isPreview && x.__N_SSG && Q(Object.assign({}, j, {
                                                        isBackground: !0,
                                                        persistCache: !1,
                                                        inflightCache: X
                                    ...
                                    return u((function() {
                                        ...
                                        return i(this, (function(i) {
                                            switch (i.label) {
                                                ...
                                                case 3:
                                                    return a.pathname = G(a.pathname, c), b.isDynamicRoute(a.pathname) && (o = a.pathname, a.pathname = o, Object.assign(u, j.getRouteMatcher(O.getRouteRegex(a.pathname))(x.parsePath(t).pathname) || {}), e = E.formatWithValidation(a)), v = d.removeTrailingSlash(o), [4, Promise.all([r.pageLoader._isSsg(v).then((function(t) {
                                                        return !!t && Q({
